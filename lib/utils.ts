...
export const STORAGE_KEY = "booking_board_armenes:v1";
export const BACKUP_KEY = "booking_board_armenes:backups:v1";
export const SETTINGS_KEY = "booking_board_armenes:settings:v1";
